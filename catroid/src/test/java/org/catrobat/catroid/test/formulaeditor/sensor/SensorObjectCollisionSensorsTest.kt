...
class SensorObjectCollisionSensorsTest {
    ...
    fun collidesWithFingerCollision() {
        ...
        PowerMockito.`when`(CollisionDetection.collidesWithFinger(mockLook.currentCollisionPolygon, TouchUtil
            .getCurrentTouchingPoints())).thenReturn(expectedValue.toDouble())
